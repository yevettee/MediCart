...
def targets_seed():
    ...
    return {
        ...
        # 순회 문진 복귀 홈(robot3=Docking Station 3) — 도킹 위치. patrol_intake_mission home 으로 사용.
        "home":   {"label": "홈", "x": -0.41441398221214687, "y": -1.1834801683713334, "yaw": 0.29826762982476646, "dock_after": True},
    }
