...
ARGUMENTS = [
    ...
    # 로봇 spawn pose — 기본값 = 우상단 도킹스테이션(robot1), -X(복도) 향함.
    # 좌하단 원점이라 (0,0) 은 병실2 구석이므로 도킹 위치를 기본값으로 둔다.
    DeclareLaunchArgument('x', default_value='5.30', description='spawn x'),
    ...
    DeclareLaunchArgument('yaw', default_value='3.14159', description='spawn yaw'),
]
